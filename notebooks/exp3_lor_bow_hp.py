...
import dagshub
import pickle  # Added for model serialization
...
MLFLOW_TRACKING_URI = "https://dagshub.com/sc/capstone.mlflow"
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    ...
    with mlflow.start_run():
        ...
        # Save model locally with pickle and log as artifact
        model_path = f"temp_models/best_model.pkl"
        ...
        # Also save the vectorizer for future use
        vectorizer_path = f"temp_models/vectorizer.pkl"
